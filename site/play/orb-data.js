...
var PROFILING_PROMPTS = [
  ...
  { id: "PRF_J05", chapter: "personal", role: "action", type: "self", promptType: "truth",
    intensity: 3.8, text: "On a scale of 1 to 10, how jealous are you? And does your partner agree with that number?",
  ...
  { id: "CPF_D12", chapter: "personal", role: "action", type: "directed", promptType: "truth",
    intensity: 4, text: "Rate how well {target} really knows you — from 1 to 10. Now explain why it's not a 10.",
    target: "other", _profileDim: "ego", _profileWeight: 1, _couplesOnly: true },
  ...
  { id: "CQ_25", chapter: "personal", role: "interaction", type: "directed", promptType: "truth",
    intensity: 2, text: "Rate {target}'s cooking on a scale of 1 to 10. No lying. {target}, do you accept that score?",
    target: "other", _profileDim: "boldness", _profileWeight: 0.5, _couplesOnly: true },
...
var REVELATION_MAP = {
  ...
  "PRF_J05": { theme: "jealousy_scale",    dim: "jealousy",   reveal: "rated their jealousy on a scale of 1 to 10",    nudge: "jealousy score" },
  // ─── COUPLES DISCOVERY ───
...
var DANCE_AND_CLOSENESS_PROMPTS = [
  ...
  { id: "DNC_MF002", chapter: "flirty", role: "build", type: "directed", promptType: "dare", intensity: 4.5,
    ...
    target: "other", actor_gender: "male", target_gender: "female" },
  { id: "DNC_MF003", chapter: "suggestive", role: "action", type: "directed", promptType: "dare", intensity: 6,
  ...
  { id: "DNC_FM002", chapter: "flirty", role: "build", type: "directed", promptType: "dare", intensity: 4.8,
    ...
    target: "other", actor_gender: "female", target_gender: "male" },
  { id: "DNC_FM003", chapter: "suggestive", role: "action", type: "directed", promptType: "dare", intensity: 6.2,
    ...
    target: "other", actor_gender: "female", target_gender: "male" },
  { id: "DNC_FM004", chapter: "intimate", role: "build", type: "directed", promptType: "dare", intensity: 7.2,
...
var HUMOR_PROMPTS = [
  ...
  { id: "HMR013", chapter: "playful", role: "action", type: "self", promptType: "truth", intensity: 2.5,
    text: "What's the weirdest thing you find attractive in a person? The group rates how weird it actually is on a scale of 1 to 10.", target: "self" },
  ...
  { id: "HMR017", chapter: "playful", role: "setup", type: "directed", promptType: "dare", intensity: 2.5,
    text: "{actor}, give {target} a rating out of 10 based purely on their dance potential. Then prove your own rating is higher.", target: "other" },
